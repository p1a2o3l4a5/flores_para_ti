...
.flowers {
  position: relative;
  transform: scale(0.70) translateY(6vmin);
  z-index: 2;
}
...
.line-1 {
  animation: typing 3s steps(20) 1.5s forwards, blink 0.7s infinite;
}
.line-2 {
  animation: typing 4s steps(30) 5s forwards, blink 0.7s infinite;
}
.line-3 {
  animation: typing 4.5s steps(35) 9.5s forwards, blink 0.7s infinite;
}
.line-4 {
  animation: typing 5.5s steps(40) 14.5s forwards,
             glow 2.5s infinite alternate;
  border-right: none;
}
...
@keyframes glow {
  from {
    text-shadow: 0 0 5px #ffd700, 0 0 15px rgba(255,215,0,0.6);
  }
  to {
    text-shadow: 0 0 15px #fff, 0 0 30px rgba(255,255,255,0.9);
  }
}
    </style>
...
<div class="romantic-message">
    <span class="line line-1">Estas flores son para TI, por esforzarte</span>
    <span class="line line-2">cada dia en ser el mejor enfermero</span>
    <span class="line line-3">y tambien solo por el hecho de existir</span>
    <span class="line line-4">TE AMO AMORCITO y SUERTE en tu dia❤️</span>
